...
Route::middleware('auth')->group(function() {
    ...
    Route::post('/products',[\App\Http\Controllers\ProductController::class,'store'])->name('admin.product.post')->withoutMiddleware('auth');
    /**
     * Product end
     */
    /**
     * category Start
     */
    Route::get('/categories',[\App\Http\Controllers\ProductCategoryController::class,'index'])->name('admin.product_categories.index');
    Route::get('/categories/create',[\App\Http\Controllers\ProductCategoryController::class,'create'])->name('admin.product_categories.create');
    Route::post('/categories',[\App\Http\Controllers\ProductCategoryController::class,'store'])->name('admin.product_categories.post')->withoutMiddleware('auth');
    /**
     * category end
     */
});
Route::middleware('auth')->group(function() {
    Route::get('/sales',[\App\Http\Controllers\SaleController::class,'index'])->name('admin.sales.index');
    Route::get('/sales/create',[\App\Http\Controllers\SaleController::class,'create'])->name('admin.sales.create');
    Route::post('/sales',[\App\Http\Controllers\SaleController::class,'store'])->name('admin.sales.post')->withoutMiddleware('auth');
});
