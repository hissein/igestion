        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i>{{ \MoneyFormat::format_money($semesterincomes) }}</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-bank text-info"></i> {{ \MoneyFormat::format_money($monthlybalance) }}</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
        ...
        <div class="col-lg-4">
            <div class="card card-chart">
                <div class="card-header">
                    ...
                    <h3 class="card-title"><i class="tim-icons icon-paper text-success"></i> {{ \MoneyFormat::format_money($semesterexpenses) }}</h3>
                </div>
                <div class="card-body">
                    <div class="chart-area">
                            ...
                            <tbody>
                                @foreach ($unfinishedsales as $sale)
                                    <tr>
                                        ...
                                        <td>{{ \MoneyFormat::format_money($sale->transactions->sum('amount')) }}</td>
                                        <td>{{ \MoneyFormat::format_money($sale->products->sum('total_amount')) }}</td>
                            ...
                            <tbody>
                                ...
                                @foreach($lasttransactions as $transaction)
                                    <tr>
                                        ...
                                        <td>{{ \MoneyFormat::format_money($transaction->amount) }}</td>
                                        <td class="td-actions text-right">
